...
const (
	...
	Testcontainers    string = "testcontainers"
)

var AllowedAdvancedFeatures = []string{string(Htmx), string(GoProjectWorkflow), string(Websocket), string(Tailwind), string(Testcontainers)}
